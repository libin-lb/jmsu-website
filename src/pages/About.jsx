      ...
      <section className="section">
        <div className="container">
          ...
          <div className="card">
            ...
            <p style={{ marginBottom: 12 }}>
              学校现有学府街校区等多个校区，校园占地面积170余万平方米。设有临床医学院、口腔医学院、药学院、机械工程学院、信息电子技术学院、材料科学与工程学院、理学院、经济与管理学院、人文学院、外国语学院、教育科学学院、美术学院、音乐学院、体育学院、生命科学学院、农业与水利工程学院等17个学院（部），开设本科专业80余个，覆盖医学、工学、理学、农学、经济学、管理学、文学、法学、教育学、艺术学10大学科门类。
            </p>
            <p style={{ marginBottom: 12 }}>
